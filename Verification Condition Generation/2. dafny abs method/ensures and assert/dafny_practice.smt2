...
(assert  (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (and (= (Ctor boolType) 0) (= (Ctor intType) 1)) (= (Ctor realType) 2)) (forall ((arg0 Bool) ) (! (= (U_2_bool (bool_2_U arg0)) arg0)
...
(= (type (MapType0Store arg0@@9 arg1@@3 arg2)) (MapType0Type aVar0 aVar1@@0))))
 ...
 :weight 0
)))) (= (Ctor refType) 4)) (forall ((arg0@@10 T@T) ) (= (Ctor (FieldType arg0@@10)) 5))) (forall ((arg0@@11 T@T) ) (! (= (FieldTypeInv0 (FieldType arg0@@11)) arg0@@11)
...
))) (= (Ctor MapType1Type) 6)) (forall ((arg0@@13 T@U) (arg1@@5 T@U) (arg2@@0 T@U) ) (! (= (type (MapType1Store arg0@@13 arg1@@5 arg2@@0)) MapType1Type)
...
(assert (forall ((h T@U) (k T@U) ) (!  (=> (and (and (= (type h) (MapType0Type refType MapType1Type)) (= (type k) (MapType0Type refType MapType1Type))) ($HeapSucc h k)) (forall ((o T@U) ) (!  (=> (and (= (type o) refType) (U_2_bool (MapType1Select (MapType0Select h o) alloc))) (U_2_bool (MapType1Select (MapType0Select k o) alloc)))
 :pattern ( (MapType1Select (MapType0Select k o) alloc))
)))
 :pattern ( ($HeapSucc h k))
)))
(assert  (and (and (and (and (and (and (and (forall ((arg0@@14 T@T) (arg1@@6 T@T) ) (= (Ctor (MapType2Type arg0@@14 arg1@@6)) 7)) (forall ((arg0@@15 T@T) (arg1@@7 T@T) ) (! (= (MapType2TypeInv0 (MapType2Type arg0@@15 arg1@@7)) arg0@@15)
...
(= (type (MapType2Store arg0@@18 arg1@@10 arg2@@2 arg3)) (MapType2Type aVar0@@0 aVar1@@3))))
 ...
 :weight 0
)))) (forall ((arg0@@19 T@U) (arg1@@11 T@U) (arg2@@3 T@U) (arg3@@0 Bool) ) (! (= (type (|lambda#1| arg0@@19 arg1@@11 arg2@@3 arg3@@0)) (MapType2Type refType boolType))
 :pattern ( (|lambda#1| arg0@@19 arg1@@11 arg2@@3 arg3@@0))
))))
(assert (forall ((|l#0| T@U) (|l#1| T@U) (|l#2| T@U) (|l#3| Bool) ($o T@U) ($f T@U) ) (! (let ((alpha@@1 (FieldTypeInv0 (type $f))))
 (=> (and (and (and (and (= (type |l#0|) refType) (= (type |l#1|) (MapType0Type refType MapType1Type))) (= (type |l#2|) (FieldType boolType))) (= (type $o) refType)) (= (type $f) (FieldType alpha@@1))) (= (U_2_bool (MapType2Select (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o $f))  (=> (and (not (= $o |l#0|)) (U_2_bool (MapType1Select (MapType0Select |l#1| $o) |l#2|))) |l#3|))))
 :pattern ( (MapType2Select (|lambda#1| |l#0| |l#1| |l#2| |l#3|) $o $f))
)))
...
(assert (forall ((a T@U) (b T@U) (c T@U) ) (!  (=> (and (and (and (and (= (type a) (MapType0Type refType MapType1Type)) (= (type b) (MapType0Type refType MapType1Type))) (= (type c) (MapType0Type refType MapType1Type))) (not (= a c))) (and ($HeapSucc a b) ($HeapSucc b c))) ($HeapSucc a c))
...
(declare-fun |call2formal@y#0@0| () Int)
(declare-fun $FunctionContextHeight () Int)
(assert  (and (and (and (= (type $_Frame@0) (MapType2Type refType boolType)) (= (type null) refType)) (= (type $Heap) (MapType0Type refType MapType1Type))) (= (type $Heap@0) (MapType0Type refType MapType1Type))))
(set-option :timeout 0)
(set-option :rlimit 0)
(assert (not
 (=> (= (ControlFlow 0 0) 3) (let ((anon0_correct  (=> (and (and (and (= $_Frame@0 (|lambda#1| null $Heap alloc false)) (= |x##0@0| (LitInt 3))) (and ($IsGoodHeap $Heap@0) ($IsHeapAnchor $Heap@0))) (and (and (<= (LitInt 0) |call2formal@y#0@0|) (forall (($o@@0 T@U) ) (!  (=> (= (type $o@@0) refType) (=> (and (not (= $o@@0 null)) (U_2_bool (MapType1Select (MapType0Select $Heap $o@@0) alloc))) (= (MapType0Select $Heap@0 $o@@0) (MapType0Select $Heap $o@@0))))
 :pattern ( (MapType0Select $Heap@0 $o@@0))
))) (and ($HeapSucc $Heap $Heap@0) (= (ControlFlow 0 2) (- 0 1))))) (<= (LitInt 0) |call2formal@y#0@0|))))
